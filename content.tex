...
\begin{frame}{Introdução}
    ...
    \alertbf{Onde estamos no panorama da Inteligência Artificial?}
...
\begin{frame}{Introdução \cont}
	...
	\begin{example}[Calcular o \textit{output} de um perceptrão:]
		...
		\end{minipage}
		\begin{minipage}{0.45\linewidth}
			\alertbf{Primeiro caso:} $i_1 = i_2 = 4$
			\begin{equation*}
				\begin{split}
...
\begin{frame}{Introdução \cont}
	...
	\begin{equation}
		y = (\mathbf{W} + \Delta \mathbf{W}) \cdot \mathbf{I},
	\end{equation}
	...
	e, desta forma, 
	\begin{equation}
		\Delta \mathbf{W} = \frac{E}{\mathbf{I}}.
	\end{equation}
	...
	\begin{equation}
		\Delta \mathbf{W} = \alpha \left(\frac{E}{\mathbf{I}} \right).
	\end{equation}
...
\begin{frame}{Introdução \cont}
	...
	Para exemplificar este problema, vejamos, agora, \alertbf{a porta lógica XOR}:
...
\begin{frame}{\textit{Backpropagation} \cont}
    ...
    Esta técnica é considerada um técnica de \textit{\alertbf{supervised learning}}.
...
\begin{frame}{Algumas Regras de Polegar}
    ...
    \alertbf{O número de neurónios na camada oculta e o número de camadas não é sabido.}
